...
import dsw.msventas.dto.CotizacionRequest;
...
public class CotizacionService {
    ...
    @Autowired
    private dsw.msventas.client.AuthClient authClient;
    ...
    public Cotizacion registrarCotizacion(CotizacionRequest req) {
        ...
        // Resolvemos el nombre del vendedor por REST contra ms-auth (via Eureka)
        // y lo guardamos. Es la contraparte del JOIN que se elimino.
        c.setVendedor(authClient.obtenerUsername(req.getUsuario_id()));
